            ...
            <CardContent className="p-0">
              ...
              <div className="p-4">
                <div className="mb-2 ">
                  <Badge
                    variant="outline"
                    className="text-xs text-textBlack bg-gradient-to-r from-rose-500 to-pink-500 text-white px-2 py-1"
                  >
                    {item.brand}
                  </Badge>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          className="px-3 w-auto bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 border-0 shadow-lg"
                          disabled={!item.inStock}
                          onClick={() => handleAddToCart(item.id, quantity)}
                        >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              {stats.totalItems} {stats.totalItems === 1 ? 'item' : 'items'} • {stats.inStockItems}{' '}
              in stock
            </p>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={() => setShowOutOfStock((prev) => !prev)}
                />
